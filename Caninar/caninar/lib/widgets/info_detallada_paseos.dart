...
class InfromacionDetalladaPaseos extends StatefulWidget {
  String nombre;
  String imagen;
  String id;
  ...
  _InfromacionDetalladaPaseosState createState() =>
      _InfromacionDetalladaPaseosState();
}

class _InfromacionDetalladaPaseosState
    extends State<InfromacionDetalladaPaseos> {
